...
function () {
  ...
  _createClass(LineEncoder, null, [{
    key: "encode",
    value: function encode(mapDataBase, linesToEncode, posOffset, negOffset) {
    ...
    key: "checkValidityAndAdjustOffsets",
    value: function checkValidityAndAdjustOffsets(lines, offsets) {
    ...
    key: "adjustToValidStartEnd",
    value: function adjustToValidStartEnd(mapDataBase, lines, offsets) {
      var expanded = {
        front: 0,
        back: 0
      };
    ...
    key: "nodeIsInValid",
    value: function nodeIsInValid(node) {
    ...
    key: "expand",
    value: function expand(lineToAdd, lines, pathLength, offsets, positive) {
    ...
    key: "undoExpansion",
    value: function undoExpansion(lines, originalLineId, expanded, offsets, positive) {
      if (positive) {
    ...
    key: "checkShortestPathCoverage",
    value: function checkShortestPathCoverage(lStartIndex, lines, shortestPath, lEndIndex) {
    ...
    key: "addLRPsUntilFullyCovered",
    value: function addLRPsUntilFullyCovered(prevCheckResult, lines, lrpLines, shortestPaths, prevShortestPath) {
    ...
    key: "findInvalidNodeOnLinesAfterACertainLength",
    value: function findInvalidNodeOnLinesAfterACertainLength(lines, lrpIndexInLoc, shortestPathLength, lrpLines, shortestPaths, maxDist) {
    ...
    key: "findNextValidNode",
    value: function findNextValidNode(lines, lrpIndexInLoc) {
    ...
    key: "concatenateAndValidateShortestPaths",
    value: function concatenateAndValidateShortestPaths(lrpLines, shortestPaths, offsets) {
    ...
    key: "removeLRPatFront",
    value: function removeLRPatFront(lrpLines, shortestPaths, lines, offsets, length) {
    ...
    key: "removeLRPatEnd",
    value: function removeLRPatEnd(lrpLines, shortestPaths, lines, offsets, length) {
    ...
    key: "addIntermediateLRPs",
    value: function addIntermediateLRPs(lrpLines, shortestPaths, lines) {
      //todo
