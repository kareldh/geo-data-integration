...
test('decoder 4 LRPs no offsets perfect candidates', function () {
  ...
  var LRPs = _LineEncoder["default"].encode(mapDataBase, lines, 0, 0);

  var decoded = _LineDecoder["default"].decode(mapDataBase, LRPs.LRPs, LRPs.posOffset, LRPs.negOffset, decoderProperties);
...
test('findCandidatesOrProjections 4 LRPs no offsets perfect candidates', function () {
  var decoderProperties = {
    dist: 50,
    //maximum distance of a candidate node to a LRP
    bearDiff: 15,
  ...
  var LRPs = _LineEncoder["default"].encode(mapDataBase, [network.lines[26], network.lines[7], network.lines[19], network.lines[23]], 0, 0);

  var candidates = _LineDecoder["default"].findCandidatesOrProjections(mapDataBase, LRPs.LRPs, decoderProperties);
...
test('rateCandidateLine 4 LRPs no offsets perfect candidates', function () {
  var decoderProperties = {
    dist: 50,
    //maximum distance of a candidate node to a LRP
    bearDiff: 15,
  ...
  var rating = _LineDecoder["default"].rateCandidateLine({
...
test('findCandidateLines 4 LRPs no offsets extended perfect candidates', function () {
  var decoderProperties = {
    dist: 50,
    //maximum distance of a candidate node to a LRP
    bearDiff: 15,
